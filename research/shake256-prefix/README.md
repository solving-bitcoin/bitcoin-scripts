...
- **Execution class:** strict local tapscript-context execution plus a complete
  pinned Bitcoin Core v30.3 consensus spend for the 32-byte prefix; deployment
  is `consensus-validated` for that exact fixture. The full output remains
...
`generateblock`; the 2 MB witness is a consensus result, not a relay-policy
