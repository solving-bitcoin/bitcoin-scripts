//! One-shot benchmark for radix-32/table Ed25519 field multiplication.
//!
//! Run with `cargo run --release --example ed25519_u5_field_benchmark`.

use std::time::Instant;

use bitcoin::{consensus::encode::serialize, script::Instruction, Witness};
use bitcoin_lab::{
    fields::ed25519::u5_table as ed25519,
