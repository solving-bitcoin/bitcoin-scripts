...
| 16 checked nibbles to an embedded cap | `u4_nibbles_to_clamp(4,16)` | <!-- metric:u4_clamp_16 -->298<!-- /metric:u4_clamp_16 --> | <!-- metric:u4_clamp_16_stack -->18<!-- /metric:u4_clamp_16_stack -->-item peak; `min(nibble,4)`; cap embedded |
