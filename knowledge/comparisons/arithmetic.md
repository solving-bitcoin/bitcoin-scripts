...
| Public constant u32 addition | `u32_add_constant(value)` | 138 | 9-byte/4-item witness; 10-item peak; no hints |
...
addend: the checked four-limb adapter uses 138 locking bytes, a representative
