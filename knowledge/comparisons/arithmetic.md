...
| 16 checked nibbles to an embedded-threshold mask | `u4_nibbles_to_lt_mask(5,16)` | <!-- metric:u4_lt_mask_16 -->218<!-- /metric:u4_lt_mask_16 --> | <!-- metric:u4_lt_mask_16_stack -->18<!-- /metric:u4_lt_mask_16_stack -->-item peak; one output bit per input; threshold embedded |
