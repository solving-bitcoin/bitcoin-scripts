...
| 16 checked nibbles to embedded three-way classes | `u4_nibbles_to_trichotomy(5,16)` | <!-- metric:u4_trichotomy_16 -->426<!-- /metric:u4_trichotomy_16 --> | <!-- metric:u4_trichotomy_16_stack -->18<!-- /metric:u4_trichotomy_16_stack -->-item peak; `0/1/2` for `< /=/>`; threshold embedded |
