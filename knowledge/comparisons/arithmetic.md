...
| 16 checked nibbles to an embedded-equality mask | `u4_nibbles_to_eq_mask(5,16)` | <!-- metric:u4_eq_mask_16 -->0<!-- /metric:u4_eq_mask_16 --> | <!-- metric:u4_eq_mask_16_stack -->0<!-- /metric:u4_eq_mask_16_stack -->-item peak; one output bit per input; symbol embedded |
