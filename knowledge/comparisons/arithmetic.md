...
| 16 checked nibbles to presence bits | `u4_nibbles_to_presence_bits(16)` | <!-- metric:u4_presence_bits_16 -->0<!-- /metric:u4_presence_bits_16 --> | <!-- metric:u4_presence_bits_16_stack -->0<!-- /metric:u4_presence_bits_16_stack -->-item peak; 16 Boolean outputs; no bitwise opcode |
