...
| FastWots32 bitwise | 32-byte message | 4,327 | 1,680–1,942 | 334 | Canonical bits; exact suffix hashes; relaxed chain-item length; recovers message |
...
| FastWots32 exact | 32-byte message | 5,409 | 1,476–1,542 | 137 | Exact suffix hashes; 498 on the balanced vector |
| FastWots32 strict lookup | 32-byte message | 5,013 | 1,476–1,542 | 143 | 729 hashes on the balanced vector; explicit range check |
| FastWots32 exact + clear | 32-byte message | 5,477 | 1,476–1,542 | 137 | Fused checksum accumulator; terminal predicate excluded |
...
There is no universal winner. The Fast bitwise recovery fragment is 581 bytes
(11.8%) smaller than the legacy list-pick fragment; its terminal form is 700
