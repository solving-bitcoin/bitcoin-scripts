...
- **Popcount:** the new eight-nibble checked Hamming-weight fragment is 135
  bytes with a 17-byte witness and a 27-item strict peak. It returns one count
  rather than the 32 individual bits produced by decomposition.
