...
`u32_or_constant(value)` consumes the top four canonical byte limbs, checks
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Embedded mask `0x89abcdef` | 768 | 13 bytes | 13 bytes | 4 | 0 | 272 | 544 |
...
combined main-plus-alt-stack limit. The 544 figure is a static non-push
