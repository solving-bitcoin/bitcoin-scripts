...
| `verify_preimage_length_with_offset(commitment, 0)` | <!-- metric:preimage_length_offset0 -->42<!-- /metric:preimage_length_offset0 --> bytes | <!-- metric:preimage_length_offset0_witness -->2<!-- /metric:preimage_length_offset0_witness --> bytes (empty preimage) | <!-- metric:preimage_length_offset0_stack -->3<!-- /metric:preimage_length_offset0_stack --> |
| `verify_preimage_length_with_offset(commitment, 520)` | <!-- metric:preimage_length_offset520 -->46<!-- /metric:preimage_length_offset520 --> bytes | <!-- metric:preimage_length_offset520_witness -->524<!-- /metric:preimage_length_offset520_witness --> bytes (520-byte preimage) | <!-- metric:preimage_length_offset520_stack -->3<!-- /metric:preimage_length_offset520_stack --> |
