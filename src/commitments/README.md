...
| `verify_hash_path_to_altstack(31, commitment)` | <!-- metric:hash_path_altstack_31 -->365<!-- /metric:hash_path_altstack_31 --> bytes | <!-- metric:hash_path_altstack_witness_31 -->78<!-- /metric:hash_path_altstack_witness_31 --> bytes (32-byte nonce, 31 bits) | <!-- metric:hash_path_altstack_stack_31 -->34<!-- /metric:hash_path_altstack_stack_31 --> |
