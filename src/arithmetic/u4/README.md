...
| Embedded-threshold mask, 16 nibbles | <!-- metric:u4_lt_mask_16 -->218<!-- /metric:u4_lt_mask_16 --> bytes | <!-- metric:u4_lt_mask_16_stack -->18<!-- /metric:u4_lt_mask_16_stack --> items | <!-- metric:u4_lt_mask_16_opcodes -->157<!-- /metric:u4_lt_mask_16_opcodes --> |
