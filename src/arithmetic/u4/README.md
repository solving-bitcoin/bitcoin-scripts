...
| Checked MSB batch, 32 nibbles | <!-- metric:u4_msb_batch32 -->440<!-- /metric:u4_msb_batch32 --> bytes | <!-- metric:u4_msb_batch32_stack -->50<!-- /metric:u4_msb_batch32_stack --> items | <!-- metric:u4_msb_batch32_opcodes -->328<!-- /metric:u4_msb_batch32_opcodes --> |
