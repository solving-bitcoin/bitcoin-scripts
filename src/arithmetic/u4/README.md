...
| Embedded-equality mask, 16 nibbles | <!-- metric:u4_eq_mask_16 -->218<!-- /metric:u4_eq_mask_16 --> bytes | <!-- metric:u4_eq_mask_16_stack -->18<!-- /metric:u4_eq_mask_16_stack --> items | <!-- metric:u4_eq_mask_16_opcodes -->157<!-- /metric:u4_eq_mask_16_opcodes --> |
...
The embedded-equality fixture uses <!-- metric:u4_eq_mask_16_witness -->33<!-- /metric:u4_eq_mask_16_witness --> serialized witness bytes for <!-- metric:u4_eq_mask_16_witness_items -->16<!-- /metric:u4_eq_mask_16_witness_items --> data items and returns one Boolean mask item per input.
