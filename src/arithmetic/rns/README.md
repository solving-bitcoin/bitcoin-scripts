...
| --- | ---: | ---: |
| Add | <!-- metric:rns_add -->216<!-- /metric:rns_add --> bytes | 118 |
| Subtract | <!-- metric:rns_sub -->219<!-- /metric:rns_sub --> bytes | 118 |
| Multiply | <!-- metric:rns_mul -->1561<!-- /metric:rns_mul --> bytes | 903 |
...
| --- | --- | ---: | ---: |
| Canonical | Add | <!-- metric:prime_rns_add -->1131<!-- /metric:prime_rns_add --> bytes | <!-- metric:prime_rns_add_stack -->151<!-- /metric:prime_rns_add_stack --> |
...
bytes validate limbs, <!-- metric:prime_rns_bind_value_binding -->9471<!-- /metric:prime_rns_bind_value_binding -->
...
The field-specific 46-prime certificate and multiplication gate now live under
[`fields::secp256k1::rns`](../../fields/secp256k1/rns/). Its backend README owns
the fixed modulus, comparison boundary, metrics, and witness contract; this
module retains only the reusable RNS machinery.
...
<!-- metric:prime_rns_hinted_mod_mul_opcodes -->17810<!-- /metric:prime_rns_hinted_mod_mul_opcodes -->
static non-push opcodes.
...
peak. Two independent fragments cost 51,536 bytes. Its 1,391 bytes of relayout
...
<!-- metric:prime_rns_verify -->620<!-- /metric:prime_rns_verify --> bytes with a
