...
`u32_xnor_constant(value)` is a checked fixed-mask adapter. It validates one
...
678-byte fragment peaks at 272 combined main-plus-alt-stack items and has 498
